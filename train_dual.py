...
def main(opt, callbacks=Callbacks()):
    ...
    assert not ((RANK != -1 or RANK != 0) and opt.rank), 'Setting --rank conflicts with DDP mode'
    assert not ((LOCAL_RANK != -1 or LOCAL_RANK != 0) and opt.local_rank), 'Setting --local_rank conflicts with DDP mode'
